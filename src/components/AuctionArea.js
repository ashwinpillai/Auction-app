...
function AuctionArea({
  ...
  const handlePlayerUnsold = (playerId) => {
      ...
      // If we are in the Final Round, marking unsold means permanent skip
      if (isFinalRound) {
      ...
      // If in a primary round, move to the unsold list
  ...
  return (
    <div className="auction-layout">
      ...
      <TeamSidebar
        ...
        teamBudgets={teamBudgets}
        teamBudgetLimit={teamBudgetLimit}
        // onDownload={handleDownloadResults} // Assuming this is tied to FinalOutput.js download
      />
    </div>
  );
}
